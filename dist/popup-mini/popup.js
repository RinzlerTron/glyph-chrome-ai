...
async function loadStats() {
  try {
    ...
    const capturing = captureStatus.capturingStatus || {
      active: false,
      progress: ''
    };
...
function extractPageForDuplicateCheck() {
  ...
  const text = contentElement.textContent.trim().replace(/\s+/g, ' ').slice(0, 2000);
  return {
